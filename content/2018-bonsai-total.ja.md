...
また、盆栽・盆景の「美」の片鱗は分かる様になった…気がする。多分まだ1ミリくらい。

# 盆栽と盆景の違い
盆栽は一種類の植物をメインにしたもの。付け足すにしても苔や小さい植物を添える程度。その一種類をどういう風に植え、育てるかが重要となる。

盆景は複数の植物を植えたもの。組み合わせる種類、間や配置で表現するのが特徴。
...
苔玉ではない始めての盆景で、中々上手くいかないので先生にほとんどして頂いた。
...
ケイビランはすぐに葉が散ってしまう為、育てるのは難しいと言われていたので、無事育てられてホッとした。
...
今回は座学がメイン。サギソウに限らず球根のものの育て方や植生など。
...
この月から、先生に代わりにして頂く事が最後の手直しくらいに。嬉しい。
...
ラッキョウは食べる物と思っていたので、盆景として植える事にびっくり。
